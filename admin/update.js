...
const firebaseConfig = {
  ...
  function remove(){
    ...
    console.log(newID);
    //   console.log(database.ref("addevent/"+newID+"/"+removeelement));
    //   if(database.ref("addevent/"+newID+"/"+removeelement).remove()===true){
    //   console.log("removed");
    //   }
  
      alert("Event Deleted! Please refresh the site")
  }
